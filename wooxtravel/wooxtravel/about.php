                ...
                <div class="thumb">
                  ...
                  <div class="text">
                    ...
                    <ul>
                      ...
                      <li><i class="fa fa-building"><a href="hotel.html"> Available hotels</a></i></li>
                      <li><i class="fa fa-plane"></i> Airplane Bill Included</li>
                      <li><i class="fa fa-taxi"><a href="vehicle.html">vehicles</a></i></li>
                      <li><i class="fa fa-map"><a href="plan.html">Best Plan</a></i></li>
                      <li><i class="fa fa-drumstick-bite"><a href="/Online-food-ordering-app-main/index.html"> Food Order</a></i> </li>
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="section-heading">
            ...
            <p>Travel websites provide information and booking services for flights, hotels, car rentals, and vacation packages to help plan and organize trips.</p>
          </div>
          <div class="row">
