...
<?php 
  ...
  $vehicles = $conn->query("SELECT * FROM vehicles ORDER BY price ASC LIMIT 4");
  $vehicles->execute();

  $allvehicles = $vehicles->fetchAll(PDO::FETCH_OBJ);
          ...
          <div class="col-lg-6 col-sm-6">
            <div class="item">
              <div class="row">
                <div class="col-lg-6">
                  <div class="image">
                    <img src="<?php echo CITIESIMAGES; ?>/<?php echo $vehicles->image; ?>" alt="">
                  </div>
                </div>
                <div class="col-lg-6 align-self-center">
                  <div class="content">
                    <span class="info">*Limited Offer Today</span>
                    <h4><?php echo $vehicles->name; ?></h4>
                    <div class="row">
                      <div class="col-6">
                        <i class="fa fa-clock"></i>
                        <span class="list"><?php echo $vehicles->trip_days; ?> days</span>
                      </div>
                      <div class="col-6">
                        <i class="fa fa-map"></i>
                    ...
                    <p>Limited Price: $<?php echo $vehicles->price; ?> per person</p>
                    <?php if(isset($_SESSION['username'])) : ?>

                      <div class="main-button">
                        <a href="reservation2.php?id=<?php echo $vehicles->id; ?>">Place an order</a>
                      </div>
                    <?php else : ?>
