...
<?php 
  ...
  $foods = $conn->query("SELECT * FROM foods ORDER BY price ASC LIMIT 4");
  $foods->execute();

  $allfoods = $foods->fetchAll(PDO::FETCH_OBJ);
          ...
          <div class="col-lg-6 col-sm-6">
            <div class="item">
              <div class="row">
                <div class="col-lg-6">
                  <div class="image">
                    <img src="<?php echo CITIESIMAGES; ?>/<?php echo $foods->image; ?>" alt="">
                  </div>
                </div>
                <div class="col-lg-6 align-self-center">
                  <div class="content">
                    <span class="info">*Limited Offer Today</span>
                    <h4><?php echo $foods->name; ?></h4>
                    <div class="row">
                      <div class="col-6">
                        <i class="fa fa-clock"></i>
                        <span class="list"><?php echo $foods->trip_days; ?> days</span>
                      </div>
                      <div class="col-6">
                        <i class="fa fa-map"></i>
                    ...
                    <p>Limited Price: $<?php echo $foods->price; ?> per person</p>
                    <?php if(isset($_SESSION['username'])) : ?>

                      <div class="main-button">
                        <a href="reservation1.php?id=<?php echo $foods->id; ?>">Place an order</a>
                      </div>
                    <?php else : ?>
