...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Pacifico|Paytone+One" rel="stylesheet">
	<link rel="stylesheet" type="text/css" href="DRS-HomeCSSnew.css">
</head>
...
<body>
	...
	<nav class="navbar navbar-inverse">
		<div class="container">
			<div class="navbar-header">
				<a href="#" class="navbar-brand"><img src="4b5d99c4-2f06-45be-88b2-5e4bb39f9885.png" id="logo"> DRS AIRWAYS</a>
  ...
  <!--Tabs-->
    ...
    <div class="tab-content">
      ...
      <div id="home" class="tab-pane fade in active">
        ...
        <form action="DRS-HomeConn.php" method="POST"> 
          <select name="origin" class="drop" id="ori">
          <option value="org">Origin</option>
        	 <option value="Origin">INDIA</option>
        	 <option value="Mumbai">EGYPT</option>
        	 <option value="Delhi">AFRICA</option>
        	 <option value="Banglore">USA</option>
        	
          </select>
          <i class="fas fa-exchange-alt"></i>
          <select name="destination" class="drop" id="dest">
          <option value="org">DESTINATION</option>
      ...
      <div id="menu1" class="tab-pane fade">
        ...
        <form action="DRS-Ticket.php" method="POST">
      ...
      <div id="menu2" class="tab-pane fade">
        ...
        <form action="DRS-FlightStatus.php" method="POST">
          ...
          <select name="origin" class="drop2">.
          	...
          	<option value="Delhi">AFRICA</option>
          	<option value="Banglore">EGYPT</option>
          	<option value="Kolkata">USA</option>
          </select>
  ...
  <!--Login Modal End-->
  <script type="text/javascript" src="DRS-HomeJSnew.js"></script>
</body>
</html>
