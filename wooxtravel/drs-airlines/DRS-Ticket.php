...
<html>
<head>
	<title>DRS Airways - Ticket</title>
	<link rel="stylesheet" type="text/css" href="DRS-TicketCSS.css">
</head>
<body>
					...
					if($_POST['submit'])
					{
						...
						if(mysqli_query($conn,$sql))
						{
							...
							while($row = mysqli_fetch_assoc($print))
							{
								...
								/*echo "<td><a href='DRS-Book.php?varname=<?php echo $var_value ?>'>Book</a></td>";*/
								echo "</tr>";
							}
						}
						else
