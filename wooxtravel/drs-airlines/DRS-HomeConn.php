...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="DRS-About.php"><strong>About</strong></a></li>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" name="usernameSignUp" placeholder="Username" id="usernameSignUp" autocomplete="username">
                    <br>
                    <label for="email">Email ID:</label>
                    <input type="email" name="emailid" placeholder="Email Id" id="email" autocomplete="email">
                    <br>
                    <label for="passSignUp">Password:</label>
                    <input type="password" name="passwordSignUp" id="passSignUp" autocomplete="new-password">
                    <br>
                    <label for="confpass">Confirm Password:</label>
                    <input type="password" name="confpassword" id="confpass" autocomplete="new-password">
                    <br>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" name="usernameLogin" placeholder="Username" id="usernameLogin" autocomplete="username">
                    <br>
                    <label for="passLogin">Password:</label>
                    <input type="password" name="passwordLogin" id="passLogin" autocomplete="current-password">
                    <br>
    ...
    <div class="container">
        ...
        <form method="POST" action="DRS-HomeConn.php">
            ...
            <input type="number" name="passengers" placeholder="Passengers" id="passengers">
					...
					if ($_POST['submit']) {
						...
						if (mysqli_query($conn, $sql)) {
							...
							while ($row = mysqli_fetch_assoc($print)) {
								...
								echo "<td><form method='GET' action='DRS-Book.php'>
